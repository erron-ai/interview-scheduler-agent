"""Core logic for interview_scheduler_agent."""
...
def analyze_records(records: list[dict[str, Any]]) -> AnalysisResult:
    ...
    return AnalysisResult(
        ...
        score=score,
        summary=f"{summary} result for: Cross-timezone interview scheduling with conflict detection and auto-rescheduling.",
        signals=signals,
    )
